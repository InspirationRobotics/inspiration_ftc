...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(8.2, 0, 0.04);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(9.5, 0, 0.01);
