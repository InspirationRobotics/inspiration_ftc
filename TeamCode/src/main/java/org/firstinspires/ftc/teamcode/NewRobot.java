...
public class NewRobot
{
    ...
    /* servos */
    public Servo servoWobbleGoal;           /* p4 */
    ...
    public DcMotorEx shooterTwo = null;       /* p2 */
    public DcMotor collector = null;

    /* servos */
    public Servo shooterTilt;                 /* p5 */
    public Servo magazine;                /* p4 */
    ...
    {
        shooterTilt = hwmap.get(Servo.class, "shooterTilt");
        magazine = hwmap.get(Servo.class, "magazine");
    ...
    public void initMiscMotors()
    {
        ...
        shooterTwo = hwmap.get(DcMotorEx.class, "shooterTwo");
